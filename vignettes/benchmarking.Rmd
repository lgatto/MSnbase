...
once. Data access does not prohibit interactive usage, such as
...
cleaning, ... is cleverly cached and only applied when the data is
...
For general functionality about the on-disk `MSnExp` data class and `r
Biocpkg("MSnbase")` in general, see other vignettes available with 
