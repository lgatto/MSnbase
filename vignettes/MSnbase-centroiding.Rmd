...
The lower panel in the plot above shows the individual signal
intensities measured by the mass spectrometer over retention time for
the selected m/z, while the upper part displays the *base peak
...
spectrometer. Each column of data points (for a discrete time point)
represents the signal for the ion in one spectrum. Below we plot the
signal for one of of the `r length(serine)` spectra containing signal
for serine.
