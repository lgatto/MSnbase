...
\item Other meta data, including experimental phenotype, file name(s)
  ...
  details in their respective manual pages. See \Robject{?MSnExp} and
  ...
  See \Robject{?MIAPE} for more details.
\end{itemize}
...
\Biocpkg{MSnbase}. See \Robject{?ReporterIons} for details about how
...
\Biocpkg{Biobase} package. \Robject{MSnSet} instances are very
...
\Biocpkg{MSnbase} provides, among others, a \Robject{ReporterIons}
...
@
\caption{PCA plot of the averaged \Robject{MSnSet}. The point sizes
