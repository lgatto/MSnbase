...
\Biocpkg{MSnbase}. See \Rfunction{?ReporterIons} for details about how
to generate new \Rclass{ReporterIons} objects.
...
methods and general advice on data imputation.
