...
- Fix defaults in `calculateFragments` man page (see issue [#537](https://github.com/lgatto/MSnbase/issues/537)).
...
- Fix bug in `readSRMData` (issue [#486](https://github.com/lgatto/MSnbase/issues/486)) which caused the function to not
...
- Fix bug in MSnSet constructor (see issue [#386](https://github.com/lgatto/MSnbase/issues/386)) <2018-12-07 Fri>
- Add filterPolarity method (see issue [#388](https://github.com/lgatto/MSnbase/issues/388), feature requeste by
