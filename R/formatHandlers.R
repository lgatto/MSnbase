...
##' na.rm=TRUE, min.int=0,reporters=19:23,skipFullUp=24,
##' descruption=NULL,verbose=TRUE)
...
##' Default is 24.
##' @param description A character describing the data set. If left blank,
##' "Object generated by loadIspyData." is used.
...
readIspyData <- function(file="ispy_results.tsv",
  ...
  if (is.null(description))
    .description <- "Object generated by loadIspyData."
  return(new("MSnSet",
             exprs=.exprs,
