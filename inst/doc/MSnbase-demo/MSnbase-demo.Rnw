...
and create a 3.3 Mb raw data object (an \Robject{MSnExp} instance, see next section). 
...
\begin{figure}[!hbt]
  \begin{center}
<<incompdiss-plot,fig=T,echo=F,tikz=T,external=F,width=5,height=2.5>>=
