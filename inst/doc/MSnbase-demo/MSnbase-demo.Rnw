...
\begin{figure}[!ht]
<<spectrum-plot, dev='pdf', fig.width=4, fig.height=4, fig.keep='high'>>=
...
\begin{figure}[p]
<<msnexp-plot, dev='pdf', fig.width=3.7, fig.height=4.5, fig.keep='last'>>=
...
\begin{figure}[p]
<<preproc-plot, dev='pdf', fig.width=3, fig.height=6, echo=FALSE>>=
grid.newpage()
...
\begin{figure}[p]
<<quantitation-plot, dev='pdf',fig.width=5, fig.height=5, echo=FALSE>>=
grid.newpage()
...
\begin{figure}[p]
<<norm-plot, dev='pdf', fig.width=5, fig.height=7, echo=FALSE>>=
...
\begin{figure}[!ht]
<<cv-plot, dev='pdf', fig.width=5, fig.height=4, echo=FALSE>>=
print(p)
@ 
...
\begin{figure}[p]
<<msnexp-norm-plot, dev='pdf', fig.width=5, fig.height=6, echo=FALSE>>=
print(p)
@ 
...
\begin{figure}[!hbt]
<<incompdiss-plot, dev='pdf', fig.width=5, fig.height=2.5, echo=FALSE, warning=FALSE>>=
