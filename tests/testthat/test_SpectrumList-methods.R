...
test_that("mz, intensity, rtime work", {
    ...
    spl <- c(spl, SpectrumList(new("Spectrum2")))
    ...
    ## Empty spectra
    spl <- SpectrumList(new("Spectrum1"), new("Spectrum2"))
