test_that("[,Chromatograms works", {
    ...
    expect_equal(unname(chrs[, c(FALSE, TRUE), drop = FALSE]),
                 Chromatograms(list(ch2, ch3), ncol = 1))
    expect_equal(unname(chrs[, c(FALSE, TRUE)]),
                 Chromatograms(list(ch2, ch3), ncol = 1))
...
test_that("[<-,Chromatograms works", {
    ...
    chrs[, "a"] <- list(ch2, ch1)
    expect_equal(unname(chrs[, 1]), Chromatograms(ncol = 1, list(ch2, ch1)))
